...
toannt=User.create(name: "Nguyen Huu Toan",email: "toannh@gmail.com",password: 123456,password_confirmation: 123456,admin: true,confirmed_at: Time.now)
...
sport = Category.create(name: "スポーツ")
shoping = Category.create(name: "ショッピング")
picture=Category.create(name: "写真")
movie=Category.create(name: "映画")
tool=Category.create(name: "検索ツール")
manga=Category.create(name: "漫画")
game=Category.create(name: "ゲーム")
app=Category.create(name: "アプリ")

Apptype.destroy_all
mobile=Apptype.create(name: "モバイル")
pc=Apptype.create(name: "パソコン")
